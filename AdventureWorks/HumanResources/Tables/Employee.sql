CREATE TABLE [HumanResources].[Employee] (
    ...
    CONSTRAINT [CK_Employee_BirthDate] CHECK ([BirthDt]>='1930-01-01' AND [BirthDt]<=dateadd(year,(-18),getdate())),
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Date of birth.', @level0type = N'SCHEMA', @level0name = N'HumanResources', @level1type = N'TABLE', @level1name = N'Employee', @level2type = N'COLUMN', @level2name = N'BirthDt';
